...
namespace FA.IdentitySample.MVCWeb
{
    ...
    public class ApplicationUserManager : UserManager<User>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<User>(context.Get<MVCWebDbContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<MVCWebDbContext>()));
        }
    }
